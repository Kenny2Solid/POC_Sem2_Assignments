...
class Paddle(GameObject):
    def __init__(self, canvas, x, y):  #(x, y) is the center of the paddle
        self.width = 80       #YOUDO-09:  create a width variable for self and set to 80
        self.height = 10 #YOUDO-10:  create a height variable for self and set to 10
        self.ball = None #YOUDO-11:  create a ball variable for self and set to None
        x1 = (x - self.width / 2)                                                                 
        y1 = (y - self.height / 2) 
        x2 = (x + self.width / 2) 
        y2 = (y + self.height / 2) 
...
class Brick(GameObject):
    ...
    def __init__(self, canvas, x, y, hits):
        self.width = 75  #YOUDO-18:  create a width variable for self and initialize to 75
        self.height = 20     #YOUDO-19:  create a height variable for self and initialize to 20
        self.hits = hits     #YOUDO-20:  create a hits variable for self and initialize to hits 
